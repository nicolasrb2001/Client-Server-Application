...
public class ChatClient3 implements Runnable {
    ...
    private static void setup_client_threads(ChatClient3 client) throws InterruptedException {
        for (int i = 0; i < 2; i++) {
